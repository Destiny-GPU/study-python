...
|------|------|----------|
| `# 注释` | 单行注释 | 解释复杂逻辑 |
| `"""docstring"""` | 文档字符串 | 模块/函数/类/方法说明 |
| `:param x:` | 参数说明 | Sphinx/reStructuredText |
| `Args:` | 参数说明 | Google 风格 |
| `:return:` | 返回值 | Sphinx/reStructuredText |
| `Returns:` | 返回值 | Google 风格 |
| `:raises X:` | 异常说明 | Sphinx/reStructuredText |
| `TODO:` | 待完成 | 标记未完成的功能 |
| `FIXME:` | 待修复 | 标记已知问题 |
| `help(obj)` | 查看帮助 | 交互式查询文档 |
