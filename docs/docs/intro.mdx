...
import { LearningPath } from '@site/src/components';
...
2. **检查 Python 版本**：在终端运行 `python --version`，确认你使用的是 Python 3.12 或更高版本
3. **修改 Hello World**：将 `print("Hello, World!")` 修改为打印你自己的名字和一句欢迎语
